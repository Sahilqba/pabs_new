...
export function middleware(request) {
    ...
    if ((request.nextUrl.pathname === '/userProfile' || request.nextUrl.pathname === '/appointmentBooking' || request.nextUrl.pathname === '/docAppointment') && !token) {
...
export const config = {
  matcher: ["/userProfile", "/appointmentBooking", "/userlogin", "/userRegistration", "/userRoleVanilla", "/docAppointment"],
}
